 ...
 */
#ifndef OLD_STACKED_PD_LINALG_H
#define OLD_STACKED_PD_LINALG_H

#include "utils/CSC_matrix.h"
#include "utils/permuted_dense.h"
#include "utils/stacked_pd.h"

/* Legacy "B is a stacked_pd" BA kernels: C = B @ A where B is spd and A is
   CSC / permuted_dense / stacked_pd. No production atom currently produces
   a stacked_pd in the *left*-operand position of a B @ A composition
   (stacked_pds appear only as derived Jacobians, never as constant
   coefficients), so these kernels and their matrix_BTA dispatcher entries
   were moved out of production paths. They are kept here as a reference
   implementation and exercised by tests/old-code/test_old_stacked_pd.h. */
